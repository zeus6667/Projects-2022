...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		private void FixedUpdate()
		{
			...
			GroundedCheck();
			Move();
			if(iskeySpanned == false && levelgoal.isgoalComplete)
			{
				iskeySpanned = true;
				GetKey();
			}
		...
		public void GetKey()
		{
				...
				Instantiate(key, new Vector3(xPos, 0, zPos), Quaternion.identity);
		}
		public void FinalDoor()
		{
				...
				xPos = Random.Range(90, -90);
				zPos = Random.Range(90, -90);
				Instantiate(finalDoor, new Vector3(xPos, 0, zPos), Quaternion.identity);
		}
